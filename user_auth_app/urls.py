...
from .views import  signup, login, index,  patient_dashboard, doctor_dashboard, add_new_blog, view_blog, patients_view_blog, patient_dashboard, doctor_dashboard, blog_details_1, blog_details_2, update_blog_draft_status, delete_blog
urlpatterns = [
